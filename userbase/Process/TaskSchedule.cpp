...
void TaskSchedule::ShowError(char *lpszText, DWORD dwErrCode)
{
#if _DEBUG
...
TaskSchedule::TaskSchedule(void)
{
	m_lpITS = NULL;
	m_lpRootFolder = NULL;
	//初始化COM
...
BOOL TaskSchedule::Delete(char *lpszTaskName)
{
...
BOOL TaskSchedule::DeleteFolder(char *lpszFolderName)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::NewTask(char *lpszTaskName, char *lpszProgramPath, char *lpszParameters, char *lpszAuthor)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::IsExist(char *lpszTaskName)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::IsTaskValid(char *lpszTaskName)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::Run(char *lpszTaskName, char *lpszParam)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::IsEnable(char *lpszTaskName)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
...
BOOL TaskSchedule::SetEnable(char *lpszTaskName, BOOL bEnable)
{
	if(NULL == m_lpRootFolder)
	{
		return FALSE;
